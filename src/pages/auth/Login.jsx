          ...
          <div className="hidden lg:block space-y-6">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-3 leading-relaxed">
                ...
                connect with top opportunities.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Get matched with jobs that fit your profile",
                },
                {
                  icon: ClipboardList,
                  title: "Application Tracking",
                  desc: "Follow all your applications in real-time",
                },
                {
                  icon: Building2,
                  title: "Top Companies",
                  desc: "Connect with the best companies in your field",
                },
              ].map((item) => (
